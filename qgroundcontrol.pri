...
# ensure that message only appear once for each project (and not
# for each Makefile generated by qmake)
...
macx { 
    ...
    contains( HARDWARE_PLATFORM, 9.6.0 ) || contains( HARDWARE_PLATFORM, 9.7.0 ) || contains( HARDWARE_PLATFORM, 9.8.0 ) || || contains( HARDWARE_PLATFORM, 9.9.0 )
    {
        ...
        !build_pass:message(Building for Mac OS X 32bit/Leopard 10.5 and earlier)
        ...
        CONFIG += x86_64 cocoa
        CONFIG -= x86 phonon
        !build_pass:message(Building for Mac OS X 64bit/Snow Leopard 10.6 and later)
    }
...
linux-g++ { 
    ...
    contains( HARDWARE_PLATFORM, x86_64 ) {
        ...
        !build_pass:message(Building for GNU/Linux 64bit/x64)
    } else {
        # 32-bit Linux
        #LIBS += \
           #-L$$BASEDIR/lib/flite/linux32
        !build_pass:message(Building for GNU/Linux 32bit/i386)
    }
    LIBS += \
        -L/usr/lib \
        -lm \
...
win32 { 
    ...
    !build_pass:message(Building for Windows Platform (32/64bit))
