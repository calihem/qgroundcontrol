...
class UASInterface : public QObject
{
	...
	public:
		...
		//TODO: Move battery from UAS to UASInterface

		UASInterface(int id = 0, MAV_TYPE type = MAV_GENERIC);
		...
		*/
		...
		virtual MAV_TYPE getType() const;
		/**
		...
		*/
		...
		virtual CommStatus getCommunicationStatus() const;
		/** @brief Get reference to the waypoint manager */
		virtual UASWaypointManager& getWaypointManager() = 0; // FIXME: reference should be const
	...
	protected:
		...
		//TODO: MAV_CLASS, MAV_AUTOPILOT_TYPE ...
	...
	signals:
		void messageToSend(const mavlink_message_t& message);
...
inline UASInterface::UASInterface(int id, MAV_TYPE type) :
	id(id),
	name( tr("MAV ") + QString::number(id) ),
	type(type),
	color( getNextColor() ),
	startTime(MG::TIME::getGroundTimeNow()),
	communicationStatus(COMM_DISCONNECTED)
{
}

inline int UASInterface::getID() const
{
	return id;
}

inline const QString& UASInterface::getName() const
{
	return name;
}

inline MAV_TYPE UASInterface::getType() const
{
	return type;
}

inline const QColor& UASInterface::getColor() const
{
	return color;
}

inline quint64 UASInterface::getUptime() const
{
	if(startTime == 0)
		return 0;
	else
...
inline UASInterface::CommStatus UASInterface::getCommunicationStatus() const
{
	return communicationStatus;
}

inline const QColor& UASInterface::getNextColor()
{
	// Create color map
